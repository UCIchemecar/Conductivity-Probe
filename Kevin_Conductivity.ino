...
unsigned long AnalogSampleTime,printTime,tempSampleTime, time, timeInject, timeRun, timeFinal;
...
void loop() {
  ...
  */
  ...
  if(inject && ECcurrent < 8 && !stop){
    timeFinal = millis;
    timeFinal = timeFinal / 1000.0;
    stop = true;
  }
  Serial.print("        Run Time: ");Serial.print(timeRun);Serial.print("         Inject Time: "); Serial.print(timeInject); Serial.print("       Final Time: ");Serial.print(timeFinal);
}
/*
